...
public class CreateBusinessTrip extends BasePage {
    ...
    public void fieldDepartureDatePlan(String date) {
        departureDatePlan.sendKeys(date + Keys.ESCAPE);
    }

    public void fieldReturnDatePlan(String date) {
        returnDatePlan.sendKeys(date + Keys.ESCAPE);
    }
